...
function addItem(element) {
    // Fonksiyonun çağrıldığı zaman input alanının değerini alıyoruz
    ...
    // Yeni bir 'div' öğesi oluşturuyoruz ve ona 'item' sınıfını ekliyoruz
    const item = document.createElement("div");
    item.classList.add("item");

    // Yeni bir 'div' öğesi oluşturuyoruz ve ona 'content' sınıfını ekliyoruz
    const item_content = document.createElement("div");
    item_content.classList.add("content");
    item.appendChild(item_content);

    // 'input' öğesini oluşturuyoruz
    const input_item = document.createElement("input");

    // 'text' sınıfını 'input' öğesine ekliyoruz
    input_item.classList.add("text");

    // 'input' öğesinin tipini 'text' olarak ayarlıyoruz
    input_item.type = "text";

    // 'input' öğesinin değerini 'item_value' olarak ayarlıyoruz
    input_item.value = item_value;

    // 'input' öğesine 'readonly' özelliğini ekliyoruz
    ...
    // 'input' öğesini 'item_content' öğesine ekliyoruz
...
const item_action =document.createElement("div")
    ...
    edit_item.addEventListener("click",(element) =>{
